...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Red}   & \textbf{Acierto} & \textbf{Parada temprana} \\
        \hline
        \ref{fig:net1} & 90.3\%           & 0                        \\
        \hline
        \ref{fig:net2} & 90.3\%           & 0                        \\
        \hline
        \ref{fig:net3} & 90.3\%           & 81                       \\
        \hline
        \ref{fig:net4} & 92.5\%           & 28                       \\
        \hline
        \ref{fig:net5} & 89.7\%           & 62                       \\
        \hline
    \end{tabular}
    \label{tab:compendio}
\end{table}
...
En la Figura \ref{fig:compendio} se pueden observar las distintas curvas fruto de la evaluación sobre el conjunto de validación. En general, se puede observar cómo, salvo por zonas puntuales del entrenamiento, la red densa con capas ocultas ha sido la que ha obtenido una mejor puntutación en este conjunto durante todo el entrenamiento, compitiendo con la red convolucional de 4 capas. Sin
\begin{wrapfigure}{r}{0.5\textwidth} % 'r' para la derecha, el ancho de la figura
    ...
    \label{fig:compendio}
\end{wrapfigure}
embargo, vemos en los resultados en el conjunto de testeo cómo esta perspectiva cambia, haciendo ver que las redes frente a datos no vistos en el entrenamiento se pueden comportar de manera muy distinta a la esperada.
